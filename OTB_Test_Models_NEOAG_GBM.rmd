...
- Example script is provided (NEOANTIGEN_GBM/GAO_OTB/analyze.R), but will not execute until file paths are corrected.

### output

```{}
library(seqinr)
TEST_DATA_LOCATION= "ENTER_FILE_NAME_HERE"
...
```{r}
TEST_DATA_LOCATION= "NEOANTIGEN_GBM/GAO_OTB/"
...
- Confirm each model (Dataset column) has 123 obs each
```{r}
...
combinedData %>% readr::write_csv(file="/Users/paulbuckley/Dropbox/ImmunogenicityBenchmark_V2_EmergingViruses/ImmunogenicityBenchmark_V2_EmergingViruses_BIB_RR/Supp_Files/2_GBM_MODEL_IMMSCORES.csv")
...
saveRDS(pr_AUC,file="GBM_PRAUC.rds")

...
## process a peptide file
peptides = fread("COV2_peptides_for_OTB_analysis.txt")
ipred_out=predict_imm(peptides$Peptide)
write.table(ipred_out,file="SARS_COV_2_DATASET/IPRED_OTB/IPRED_RESULTS.txt",sep="\t",row.names = F,quote=F)

...
data_file <-here("SARS_COV_2_DATASET", "GAO_OTB", "COV2_peptides_MHC.txt")
...
for (i in 1:nrow(peptides_MHC)){
  ...
  file_fasta <- here("SARS_COV_2_DATASET", "GAO_OTB", paste(pep, ".fasta", sep = ""))
  ...
  final_output_file <- here("SARS_COV_2_DATASET", "GAO_OTB", paste(pep, ".csv", sep = ""))
